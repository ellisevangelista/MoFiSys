 ...
 * @author Laurenz
 */
public class traceActivities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()){
            ResultSet activities = bean.userTrace(connection, pg);
            ...
            if(pg > 1){
            out.println("<a style=\"color: #515453;text-align:center;\" href=\"traceActivities?pg=" + (pg-1) + "\">Previous Page</a>");}
            
            int l = bean.getLimitU(connection);
            double a = Math.ceil(l/15);
            if(a >= pg){
            out.println("<a style=\"color: #515453;text-align:center;\" href=\"traceActivities?pg=" + (pg+1) + "\">Next Page</a>");}
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(traceActivities.class.getName()).log(Level.SEVERE, null, ex);
