...
<!DOCTYPE html>
<%
    ResultSet docuout = (ResultSet)session.getAttribute("docuout");
    ...
    <body>
        ...
        <form action="updateDocuments" target="my_iframe">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="doc_title" id="doc_title" value="<%=docuout.getString("TITLE").trim()%>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="doc_dept" value="<%=docuout.getString("DEPARTMENT").trim()%>">
                    </td>
                </tr>
                ...
                <script>
                        document.getElementById("dscrptnIn").defaultValue = "<%=docuout.getString("DOC_DSCRPTN").trim()%>";                    
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="doc_add" value="<%=docuout.getString("DOC_ADD").trim()%>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                         <input type="date" name="doc_daterelease" value="<%=docuout.getString("DATERELEASED").trim()%>">
                    </td>
                </tr>
         ...
         function typeCheck() {
            ...
            if (document.getElementById('ifOutType').checked) {
                ...
                <tr>
                    ...
                    <%
                        String stat=docuout.getString("STATUS");
                    ...
                    <td>
                        ...
                        <input type="radio" name="doc_status" onclick="javascript:yesnoCheck();" value="Settled" id="yesCheck"><text class ="b-text">&nbsp;Settled</text>
                            ...
                            <div id="ifYes" style="display:none">
                                ...
                                <input type="checkbox" name="doc_notif">
                                <text class ="b-text">
                                Notify me in: <input type="date" name="doc_notifDate" value="<%=docuout.getString("NOTIFDATE").trim()%>">
                                </text>
                                <br><br><br>
                            </div>                                  
                    </td>
         ...
         function yesnoCheck() {
            if (document.getElementById('yesCheck').checked) {
                ...
                <tr>
                    ...
                    <%String sens=docuout.getString("SENSITIVITY");%>
                    <td>
                ...
                <script>
                        document.getElementById("remarksIn").defaultValue = "<%=docuout.getString("DOC_REMARKS").trim()%>";
                ...
                <input type="hidden" name="docno" value="<%=docuout.getString("DOCNO").trim()%>">
                <input type="hidden" name="type" value="out">
            </table>
            
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <%if (phase.equals("oneout2")){%>
